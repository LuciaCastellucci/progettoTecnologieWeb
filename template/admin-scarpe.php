  ...
  ?>
    <tr>
      ...
      <td class="gestisci-modello">
        <a onReset="return ConfermaCancellazione()" href="processa_prodotto.php?action=1&id=<?php echo $scarpa["codiceModello"]?>" class="btn btn-primary position-relative btn-sm">
        ...
        <a href="processa_prodotto.php?action=2&id=<?php echo $scarpa["codiceModello"]?>" class="btn btn-primary position-relative btn-sm">
